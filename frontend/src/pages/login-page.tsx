            ...
            <div>
              <section className="flex items-center p-6 md:p-8">
                <div className="w-full px-1 md:px-2">
                  <p className="mb-2 text-sm text-muted-foreground">Faca login para acessar o sistema.</p>
                  <h1 className="mb-10 text-4xl font-semibold text-foreground md:text-[40px]">Bem-vindo de volta!</h1>
                  <LoginForm />
                </div>
              </section>
            </div>
